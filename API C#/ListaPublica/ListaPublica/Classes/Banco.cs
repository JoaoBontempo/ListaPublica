...
namespace ListaPublica.Classes
{
    public class Banco
    {
        ...
        private static string parametrosBancoAWS = "server=dblistapublica.ccenmvdsqpiw.us-east-2.rds.amazonaws.com; Port=3306; uid=gerenciamento;pwd=S3nh4F0rt3;database=db_lista_publica";
